...
def writeBufferExcelFile(data):
    ...
    for pageIndex in range(pages):
        ...
        worksheet.merge_range('M1:N1', 'Merged Cells', align_center)
        worksheet.merge_range('O1:O2', 'Merged Cells', align_center)
        ...
        worksheet.set_column_pixels('M:M',39)
        worksheet.set_column_pixels('N:N',39)
        worksheet.set_column_pixels('O:O',75)
        worksheet.set_column_pixels('P:P',186)
        worksheet.set_column_pixels('Q:Q',72)
        ...
        worksheet.write('M1:N1', 'LISTADO ENVIADO', align_center)
        worksheet.write('M2', 'FECHA', align_center)
        worksheet.write('N2', 'FOLIO', align_center)
        worksheet.write('O1:O2', 'VISTO BUENO', align_center)
        worksheet.write('P1:P2', 'OBSERVACIONES POR DEVOLUCIÓN', align_center)
        worksheet.write('Q1', 'CONSTANCIA ENVIADA AL INTERESADO', align_center)
        worksheet.write('Q2', 'FECHA', align_center)
        ...
        for i in range(registros):
            ...
            worksheet.write('M' + str(index), "", text_format)
